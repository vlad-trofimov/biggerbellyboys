...
async function loadRestaurantDataFromJSON() {
    ...
    try {
        console.log('📊 Loading restaurant data from JSON...');
        ...
        console.log(`✅ Loaded ${data.restaurants.length} restaurants from JSON (v${data.version})`);
        ...
        console.log(`🎉 Application ready with ${restaurants.length} restaurants`);
...
function initializeGlobalMap() {
    ...
    try {
        ...
        am5.ready(() => {
            ...
            console.log('✅ Global map initialized successfully with amCharts');
        });
...
function loadGlobalBellyFoodTourCountries(polygonSeries) {
    ...
    console.log('Global tour restaurants found:', globalTourRestaurants.length);
    ...
    console.log('Countries with restaurants:', Object.keys(restaurantsByCountry));
    ...
    polygonSeries.events.on("datavalidated", function() {
        console.log("Map data validated, coloring countries and adding clicks...");
        ...
        reviewedCountries.forEach(countryCode => {
            ...
            if (country) {
                console.log("Found and coloring:", countryCode);
        ...
        reviewedCountries.forEach(countryCode => {
            ...
            if (country) {
                ...
                polygon.events.on("click", function(ev) {
                    console.log("CLICK DETECTED on reviewed country!");
        ...
        content.innerHTML = titleHtml + restaurants.map(restaurant => {
            ...
            return `
                <div class="popup-content">
                    ...
                    <div class="popup-name">${restaurant.restaurant}</div>
                    <div class="popup-address">📍 <span class="clickable-location">${restaurant.location}</span></div>
                    <div class="popup-address">${restaurant.address}</div>
                    <div class="popup-rating">
                        <span class="rating-value">${restaurant.rating.toFixed(1)}</span>
...
function closeGlobalMapPopup() {
    console.log('🔒 closeGlobalMapPopup called');
